def _get_settings_module() -> str:
    ...
    default_settings_module = 'foodcast.settings.dev'
    ...
    def get_settings_module_from_environment_variable() -> str:
        variable_name = "FOODCAST_SETTINGS_MODULE"
        try:
...
exec(f'from {_get_settings_module()} import *')
